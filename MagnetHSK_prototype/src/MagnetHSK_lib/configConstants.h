...
//**********************************************************************************************************
// PORT 3
// const unsigned long TM4CSPI_clock = 23 ; //usually denoted sck
// const unsigned long CHIP_SELECT = 24; //usually denoted cs

// PORT 0
const unsigned long TM4CSPI_clock = 11; // usually denoted sck
const unsigned long CHIP_SELECT = 12;   // usually denoted cs
...
//**********************************************************************************************************
// -- Definition of the structs needed for conversion
//**********************************************************************************************************
struct table_coeffs {
...
// Thermistor
#define SENSOR_TYPE__THERMISTOR_44004_2P252K_25C                               \
  (uint32_t)0x13 << SENSOR_TYPE_LSB
...
#define SENSOR_TYPE__THERMISTOR_YSI_400_2P252K_25C                             \
  (uint32_t)0x18 << SENSOR_TYPE_LSB
...
#define RTD_EXCITATION_MODE__NO_ROTATION_NO_SHARING                            \
  (uint32_t)0x0 << RTD_EXCITATION_MODE_LSB
#define RTD_EXCITATION_MODE__NO_ROTATION_SHARING                               \
  (uint32_t)0x1 << RTD_EXCITATION_MODE_LSB
#define RTD_EXCITATION_MODE__ROTATION_SHARING                                  \
  (uint32_t)0x2 << RTD_EXCITATION_MODE_LSB
// rtd - excitation current
#define RTD_EXCITATION_CURRENT_LSB 14
#define RTD_EXCITATION_CURRENT__INVALID                                        \
  (uint32_t)0x0 << RTD_EXCITATION_CURRENT_LSB
...
#define RTD_EXCITATION_CURRENT__100UA                                          \
  (uint32_t)0x5 << RTD_EXCITATION_CURRENT_LSB
#define RTD_EXCITATION_CURRENT__250UA                                          \
  (uint32_t)0x6 << RTD_EXCITATION_CURRENT_LSB
#define RTD_EXCITATION_CURRENT__500UA                                          \
  (uint32_t)0x7 << RTD_EXCITATION_CURRENT_LSB
...
#define THERMISTOR_RSENSE_CHANNEL__NONE                                        \
  (uint32_t)0x0 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__1                                           \
  (uint32_t)0x1 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__2                                           \
  (uint32_t)0x2 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__3                                           \
  (uint32_t)0x3 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__4                                           \
  (uint32_t)0x4 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__5                                           \
  (uint32_t)0x5 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__6                                           \
  (uint32_t)0x6 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__7                                           \
  (uint32_t)0x7 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__8                                           \
  (uint32_t)0x8 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__9                                           \
  (uint32_t)0x9 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__10                                          \
  (uint32_t)0xA << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__11                                          \
  (uint32_t)0xB << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__12                                          \
  (uint32_t)0xC << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__13                                          \
  (uint32_t)0xD << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__14                                          \
  (uint32_t)0xE << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__15                                          \
  (uint32_t)0xF << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__16                                          \
  (uint32_t)0x10 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__17                                          \
  (uint32_t)0x11 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__18                                          \
  (uint32_t)0x12 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__19                                          \
  (uint32_t)0x13 << THERMISTOR_RSENSE_CHANNEL_LSB
#define THERMISTOR_RSENSE_CHANNEL__20                                          \
  (uint32_t)0x14 << THERMISTOR_RSENSE_CHANNEL_LSB
...
#define THERMISTOR_EXCITATION_MODE__NO_SHARING_NO_ROTATION                     \
  (uint32_t)0x0 << THERMISTOR_EXCITATION_MODE_LSB
#define THERMISTOR_EXCITATION_MODE__SHARING_ROTATION                           \
  (uint32_t)0x1 << THERMISTOR_EXCITATION_MODE_LSB
#define THERMISTOR_EXCITATION_MODE__SHARING_NO_ROTATION                        \
  (uint32_t)0x2 << THERMISTOR_EXCITATION_MODE_LSB
// thermistor - excitation current
#define THERMISTOR_EXCITATION_CURRENT_LSB 15
#define THERMISTOR_EXCITATION_CURRENT__INVALID                                 \
  (uint32_t)0x0 << THERMISTOR_EXCITATION_CURRENT_LSB
#define THERMISTOR_EXCITATION_CURRENT__250NA                                   \
  (uint32_t)0x1 << THERMISTOR_EXCITATION_CURRENT_LSB
#define THERMISTOR_EXCITATION_CURRENT__500NA                                   \
  (uint32_t)0x2 << THERMISTOR_EXCITATION_CURRENT_LSB
#define THERMISTOR_EXCITATION_CURRENT__1UA                                     \
  (uint32_t)0x3 << THERMISTOR_EXCITATION_CURRENT_LSB
#define THERMISTOR_EXCITATION_CURRENT__5UA                                     \
  (uint32_t)0x4 << THERMISTOR_EXCITATION_CURRENT_LSB
#define THERMISTOR_EXCITATION_CURRENT__10UA                                    \
  (uint32_t)0x5 << THERMISTOR_EXCITATION_CURRENT_LSB
#define THERMISTOR_EXCITATION_CURRENT__25UA                                    \
  (uint32_t)0x6 << THERMISTOR_EXCITATION_CURRENT_LSB
#define THERMISTOR_EXCITATION_CURRENT__50UA                                    \
  (uint32_t)0x7 << THERMISTOR_EXCITATION_CURRENT_LSB
#define THERMISTOR_EXCITATION_CURRENT__100UA                                   \
  (uint32_t)0x8 << THERMISTOR_EXCITATION_CURRENT_LSB
#define THERMISTOR_EXCITATION_CURRENT__250UA                                   \
  (uint32_t)0x9 << THERMISTOR_EXCITATION_CURRENT_LSB
#define THERMISTOR_EXCITATION_CURRENT__500UA                                   \
  (uint32_t)0xA << THERMISTOR_EXCITATION_CURRENT_LSB
#define THERMISTOR_EXCITATION_CURRENT__1MA                                     \
  (uint32_t)0xB << THERMISTOR_EXCITATION_CURRENT_LSB
#define THERMISTOR_EXCITATION_CURRENT__AUTORANGE                               \
  (uint32_t)0xC << THERMISTOR_EXCITATION_CURRENT_LSB
...
#define TC_OPEN_CKT_DETECT_CURRENT__10UA                                       \
  (uint32_t)0x0 << TC_OPEN_CKT_DETECT_CURRENT_LSB
#define TC_OPEN_CKT_DETECT_CURRENT__100UA                                      \
  (uint32_t)0x1 << TC_OPEN_CKT_DETECT_CURRENT_LSB
#define TC_OPEN_CKT_DETECT_CURRENT__500UA                                      \
  (uint32_t)0x2 << TC_OPEN_CKT_DETECT_CURRENT_LSB
#define TC_OPEN_CKT_DETECT_CURRENT__1MA                                        \
  (uint32_t)0x3 << TC_OPEN_CKT_DETECT_CURRENT_LSB
// tc - custom address
