...
/**
 * Temperature probe class for reading out external OneWire temperature probes
 */
TemperatureProbe::TemperatureProbe() {
    noprobe.temperature = noerror;
    noprobe.sn = badAddress;
}

TemperatureProbe::~TemperatureProbe() {}

sTempProbeAll TemperatureProbe::readAll()
{
    sTempProbeAll out;
...
sTempProbe TemperatureProbe::read(uint8_t cmd) {
    sTempProbe out;
    out = noprobe;
    return out;
}

sTempProbe TemperatureProbe::read(uint64_t address) {
    sTempProbe out;
    out = noprobe;
    noprobe.temperature -= 1;
    return out;
}