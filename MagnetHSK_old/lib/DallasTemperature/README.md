# Note:
This library has been copied and altered by Noah Green for compatibility with the HELIX magnet housekeeping software and the TI TIVA TM4C123GXL microcontroller.
